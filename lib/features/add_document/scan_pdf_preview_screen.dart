...
class _ScanPdfPreviewScreenState
    extends ConsumerState<ScanPdfPreviewScreen> {
          ...
          if (i == 0) {
            return pw.Column(
              children: [
                ...
                pw.Center(
                  child: pw.Text('Galiyat Development Authority',
                    style: pw.TextStyle(
                      fontSize: 20,
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Row(children: [
            ...
            const SizedBox(width: 8),
            Expanded(
              child: Text('PDF saved to device',
                style: AppTextStyles.dmSans.copyWith(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, i) {
                if (i == 0) {
                  return Column(
                    children: [
                      Image.asset('assets/images/gda_logo.png',
                        width: 70, height: 70),
                      const SizedBox(height: 12),
                      Text('Galiyat Development Authority',
            ...
            child: _isSaving
              ...
              : Row(mainAxisSize: MainAxisSize.min, children: [
                  const Icon(Icons.save_alt_rounded,
                    size: 13, color: AppColors.gdaGreen),
    ...
    return GestureDetector(
      ...
      child: Opacity(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(label, style: AppTextStyles.dmSans.copyWith(
